...
class ExperimentsControllerTest < ActionController::TestCase
  ...
  test "should create experiment" do
    assert_difference('Experiment.count') do
      post :create, experiment: { cost: @experiment.cost, description: @experiment.description, name: @experiment.name }
    end
  ...
  test "should update experiment" do
    put :update, id: @experiment, experiment: { cost: @experiment.cost, description: @experiment.description, name: @experiment.name }
    assert_redirected_to experiment_path(assigns(:experiment))
  end
